...
%%%        Verze 2.76. c2023 [cit. 20yy-mm-dd]. Dostupné na: http://www.konvoj.cz/styles/biblio/.
%%%
%%% Encoding: UTF-8
...
%%%        Verze 2.76. c2023 [cit. 20yy-mm-dd]. Available at: http://www.konvoj.cz/styles/biblio/.
%%%
%%%  This work has the maintenance status `Maintained'.
%%%  The Current Maintainer of this work is Tomáš Hála.
%%%
\def\BIBSTYversionnumber{2.77}
